...
from sqlalchemy import DateTime, Integer, String, Text, Index, ForeignKey, Enum
...
class User(Base):
    ...
    # 创建索引 ：提升查询速度
    __table_args__ = (
        Index('phone_UNIQUE', 'phone'),  # 高频查询场景
        Index('username_UNIQUE', 'username')  # 按发布时间排序
    )
    ...
    bio: Mapped[str] = mapped_column(String(100), comment="个人简介", default='这个人很懒，什么都没留下')
