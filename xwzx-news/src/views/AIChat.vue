        ...
        <div class="history-list" ref="historyListRef">
          ...
          >
            ...
            >
              ...
              <div class="delete-btn" @click.stop="confirmDeleteHistory(item.id)">
...
const handleDeleteHistory = async (id) => {
  const recordId = id || deleteRecordId.value;
  if (!recordId) {
    console.error('没有有效的记录 ID');
    return;
  }
  ...
  try {
    await axios.delete(
      `${apiConfig.baseURL}/api/ai/history/${recordId}`,
      {
        headers: {
          'Authorization': `Bearer ${userStore.token}`
        }
